...
import meu.app.apprecipes.adapters.AdapterIngrediente;
...
public class RecipeIngredientsFragment extends NavigableFragment {
    ...
    private AdapterIngrediente ingredientAdapter;
    ...
    public static RecipeIngredientsFragment newInstance(Receita recipe) {
        RecipeIngredientsFragment fragment = new RecipeIngredientsFragment();

        if (recipe.getIngredients() != null) {
            Bundle args = new Bundle();
            args.putParcelableArrayList("ingredients", (ArrayList<Ingrediente>) recipe.getIngredients());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ingredientAdapter = new AdapterIngrediente(getActivity(), ingredientList);
        ...
        addButton.setOnClickListener(v -> {
            ...
            if (!newIngredient.isEmpty()) {
                ...
                ingredientList.add(new Ingrediente(newIngredient));
                toggleEmptyView();
                ingredientAdapter.notifyDataSetChanged();
            }
        });
    ...
    public interface IngredientListener {
        void navigateToDirectionsFragment(List<Ingrediente> ingredients);
    }
}
